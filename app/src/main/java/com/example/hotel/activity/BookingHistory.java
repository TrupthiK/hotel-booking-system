...
import com.example.hotel.adapter.RequestedBookingAdapter;
...
public class BookingHistory extends AppCompatActivity implements BookingViewFetchMessage {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BookingHistory.this, UserMenu.class);
...
//        ListDataView.setLayoutManager(mLayoutManager);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(BookingHistory.this, HomePageActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
    }
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(BookingHistory.this, message, Toast.LENGTH_LONG).show();
